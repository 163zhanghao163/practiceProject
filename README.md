...
- **构筑体系**：100 张卡牌（37 普通 / 35 罕见 / 28 稀有），围绕力量、防御、毒系、连击、能量充能、**血猎**（吸血/血祭代价）、**虚空**（弃牌/手牌协同）七大流派设计，每张卡可升级一次
...
- **地图流程**：三幕分支地图随机生成（每幕 6-9 层、每层 2-5 节点，战斗 / 精英 / 事件 / 商店 / 营地 / 🎁宝箱 / 首领，Boss 前必有营地），28 种敌人（含 3 个幕首 Boss），12 个随机事件
